...
subtitle: "Lecture 1: Robotic System, Models, Dynamical Systems and State Space"
author:
...
- Operator provides desired commands
- Plant includes actuators, dynamical system, and sensors
- Controller processes outputs and produces inputs based on user commands
- Environment interacts with the system, potentially causing disturbances
::: -->
...
Based on the concept of system **state**:
- Smallest set of variables that determine system behavior
- State-space: n-dimensional space of state variables
- Represented as system of first-order differential equations

...
- Senior Control Engineer at Sber Robotics Lab (2023-Present)
...
- **Applied Optimization**: Linear, Quadratic, and Nonlinear programming, Dynamic programming, Optimal Control, Optimal Mechanical Design.

::: {.notes}
Feel free to contact me via [Telegram](https://t.me/simkasimka) and [email](s.nedelchev@innopolis.university) if you face any problems with the course or would like to do research and work on hardware.
:::

## What this course is about

This is an introductory course dedicated to control of robotic systems (mainly fully actuated). You will learn:

- Review of modeling techniques, simulators like [MuJoCo](https://mujoco.readthedocs.io/en/stable/overview.html)
...
- Introduction to advanced control techniques (optimal and adaptive control, model predictive control, etc.)
...
<!-- ::: {.notes} -->
- Attendance includes both presence and active participation in class. It is not a strict requirement to complete the course.
- Students who do not attend regularly often struggle with the course material and have difficulty passing the final exam.
- <u>Plagiarism results in a zero score for the assignment or exam. This policy is strictly enforced to maintain academic integrity.</u>
<!-- ::: -->
...
4. **Analysis and Control of Nonlinear Systems** (weeks 5-7)
...
- The structure of models (differential equations) used to describe robotic systems

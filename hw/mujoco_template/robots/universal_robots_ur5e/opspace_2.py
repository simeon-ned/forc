...
def main() -> None:
    ...
    with mujoco.viewer.launch_passive(
        ...
        # Enable site frame visualization and perturbation
        viewer.opt.frame = mujoco.mjtFrame.mjFRAME_SITE
        viewer.opt.flags[mujoco.mjtVisFlag.mjVIS_PERTFORCE] = True  # Show perturbation forces
        # viewer.pert.active = True  # Enable perturbations
        # viewer.pert.select = True  # Enable selection
        # viewer.pert.scale = 1.0    # Scale of perturbation forces

        while viewer.is_running():
            step_start = time.time()

            # Apply any perturbation forces from the mouse
            # if viewer.pert.select:
            #     data.xfrc_applied = viewer.pert.xfrc_applied
